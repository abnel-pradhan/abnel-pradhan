...
I've organized my skills using visual badges so you can see my stack at a glance:
...
**Programming Languages & AI** <p align="left">
...
|--------------|-------------|------|
| **AI Virtual Painter** | A Python-based computer vision application that allows users to draw on-screen using hand gestures (including a custom signature feature). | [View Repo](#) |
| **E-Commerce Dropshipping Store** | A fully functional, responsive online storefront built for selling t-shirts, integrating modern web dev practices. | [View Repo](#) |
