...
|--------------|-------------|------|
| **AI Virtual Painter** | A Python-based computer vision application that allows users to draw on-screen using hand gestures (including a custom signature feature). | [Live Site](https://github.com/abnel-pradhan/ai-virtual-painter) |
